...
export function PanelResizer({
  ...
  return (
    ...
    >
      <div
        className={
          "absolute inset-y-0 w-px bg-border-default transition-colors group-hover:bg-border-strong group-active:bg-text-secondary group-focus-visible:bg-text-secondary " +
